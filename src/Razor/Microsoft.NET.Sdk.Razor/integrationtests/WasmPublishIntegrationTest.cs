...
<ItemGroup>
    <ProjectReference Include=""..\classlibrarywithsatelliteassemblies\classlibrarywithsatelliteassemblies.csproj"" />
        ...
        //            Assert.FileExists(result, blazorPublishDirectory, "_framework", "_bin", "blazorwasm.dll");
        ...
        //            // Simulates publishing the same way VS does by setting BuildProjectReferences=false.
        //            // Arrange
        //            var project = ProjectDirectory.Create("blazorhosted", additionalProjects: new[] { "blazorwasm", "razorclasslibrary", "classlibrarywithsatelliteassemblies" });
        //            project.TargetFramework = TestFacts.DefaultNetCoreTargetFramework;
        //            project.Configuration = "Release";
        ...
        //            var blazorPublishDirectory = Path.Combine(publishDirectory, "wwwroot");
        //            Assert.FileExists(result, blazorPublishDirectory, "_framework", "blazor.boot.json");
        //            Assert.FileExists(result, blazorPublishDirectory, "_framework", "_bin", "ja", "blazorwasm.resources.dll");
